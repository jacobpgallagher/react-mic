/*!
 * react-mic v9.0.0 - https://hackingbeauty.github.io/react-mic
 * MIT Licensed
 */
...
var _jsxFileName = '/Users/jacobgallager/Documents/Code/react-mic/src/components/ReactMic.js';
...
var ReactMic = function (_Component) {
  ...
  ReactMic.prototype.componentDidMount = function componentDidMount() {
    ...
    if (audioElem) {
      ...
      this.setState({
        analyser: _analyser,
        microphoneRecorder: new __WEBPACK_IMPORTED_MODULE_2__libs_MicrophoneRecorder__["a" /* MicrophoneRecorder */](onStart, onStop, options),
        canvas: canvas,
        canvasCtx: canvasCtx
      }, function () {
        _this2.visualize();
...
var MicrophoneRecorder = function () {
  function MicrophoneRecorder(onStart, onStop, options) {
    var _this = this;
