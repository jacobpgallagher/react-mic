...
var ReactMic = function (_Component) {
  ...
  function ReactMic(props) {
    ...
    _this.visualize = function () {
      ...
      if (visualSetting === 'sinewave') {
        ...
        _Visualizer2.default.visualizeFrequencyCircles(analyser, canvasCtx, canvas, width, height, backgroundColor, strokeColor);
      }
    };
  ...
  ReactMic.prototype.componentDidMount = function componentDidMount() {
    ...
    if (audioElem) {
      ...
      this.setState({
        analyser: _analyser,
        microphoneRecorder: new _MicrophoneRecorder.MicrophoneRecorder(onStart, onStop, options),
        canvas: canvas,
        canvasCtx: canvasCtx
      }, function () {
        _this2.visualize();
  ...
  ReactMic.prototype.render = function render() {
    ...
    return _react2.default.createElement('canvas', { ref: 'visualizer', height: height, width: width, className: this.props.className });
  };
